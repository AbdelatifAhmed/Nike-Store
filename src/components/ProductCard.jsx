  ...
  return (
    <div className="flex flex-1 flex-col w-full max-sm:w-full  group">
      ...
      <div className="mt-8 flex justify-start gap-2.5">
        ...
        <p className="font-montserrat text-xl leading-normal text-slate-gray dark:text-slate-300">4.5</p>
      </div>
      <h3 className="mt-2 text-2xl leading-normal font-semibold font-palanquind dark:text-slate-50">{product.name}</h3>
